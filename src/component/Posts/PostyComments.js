...
const PostyComments = () => {
    return (
        <div className="comment-section">
            <Link to="/app/Home" className="plus-ic">
                    ...
                    <li>
                        <div className="comment-list">
                            ...
                            <div className="comment">
                                ...
                                <Link to="/app/Home" className="active"><i className="fa fa-reply-all"></i>Reply</Link>
                            </div>
                        </div>
                        <ul>
                            <li>
                                <div className="comment-list">
                                    ...
                                    <div className="comment">
                                        ...
                                        <Link to="/app/Home" ><i className="fa fa-reply-all"></i>Reply</Link>
                                    </div>
                                </div>
                            </li>
                        </ul>
